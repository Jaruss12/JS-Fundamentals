...
Gathering tools is a great way to start planning your solution! Re-read the problem and see why i gathered the tools i did! 
    ...
    1) find out what you need to write
    2) make a function for identifing each object
    3)make a forEach loop
    4)make an if statement for the keys if match 
    5)add the keys back that match using a push
    6)return the array
...
//         Object.keys(veggAmounts).forEach(g =>{
//             //console.log(g)
//             if(key === g){
//                 veggAmounts.splice(1, 0, )
//             }
//         })
//          }
// console.log(nameChecker())
    ...
    function name(){
        for(let i=0; i<veggAmounts.length; i++){
...
// * Examples
let societyName =["Adam", "Sarah", "Malcolm"]

// * societyName(["Harry", "Newt", "Luna", "Cho"]) ➞ "CHLN"

// * societyName(["Phoebe", "Chandler", "Rachel", "Ross", "Monica", "Joey"]) ➞ "CJMPRR"

let sort = societyName.sort()
for(name of sort){
    let letter = name.charAt(0)
     let lArr = Array.from(letter)
     console.log(lArr.toString())
